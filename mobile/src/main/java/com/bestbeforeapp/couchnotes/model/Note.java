...
public class Note {
    private static final String VIEW_NAME = "notes";
    private static final String DOC_TYPE = "note";
    ...
    public static Document createTask(Database database,
        ...
        Log.d("Note", "Created doc: %s", document.getId());
    ...
    public static void deleteTask(Document task) throws CouchbaseLiteException {
        task.delete();
        Log.d("Note", "Deleted doc: %s", task.getId());
