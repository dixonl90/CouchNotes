package com.bestbeforeapp.couchnotes.preferences;
...
public class CouchNotesPreferences {
    ...
    public CouchNotesPreferences() {
        preferences = PreferenceManager
                .getDefaultSharedPreferences(CouchNotesApplication.getAppContext());
    }
